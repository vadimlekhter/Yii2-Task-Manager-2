                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <?php
                            if (!Yii::$app->user->isGuest) {
                                echo Html::img(Yii::$app->user->identity->getThumbUploadUrl('avatar', \common\models\User::AVATAR_ICO));
                            }
                            ?>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                <?php
                                if (!Yii::$app->user->isGuest)
                                    echo Html::img(Yii::$app->user->identity->getThumbUploadUrl('avatar',
                                        \common\models\User::AVATAR_ICO))
                                ?>
                                <!--                            --><? //= Html::img(Yii::$app->user->identity->getThumbUploadUrl('avatar', \common\models\User::AVATAR_ICO)) ?>
